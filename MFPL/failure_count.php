...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Failure Count Report</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item active">Failure Count Report</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-justified" type="button" role="tab" aria-controls="home" aria-selected="true">Failure Count</button>
                        </li>
                        <!-- <li class="nav-item flex-fill" role="presentation">
                        ...
                        if (obj.error == 0 && brands != null) {
                            ...
                            $.each(output, function(i, item) {
                                ...
                                k++;
                                        ...
                                        $('#brandlist1').append('<tr><th scope="row">' + k + '</th><td>' + item + '</td><td>' + brands[i] + '</td></tr>');
            ...
            $("#recipecount").on('submit', (function(e) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        var string1 = obj.error;
                        var output = obj.count;
                        var brand = obj.brands;
                        //console.log(output[data]); 
                        //console.log(dates);
                        if (obj.error == 0 && brand != null) {
                            //swal(output);
