        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Maintainance Report</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                ...
                <div class="card-body"> 
                    ...
                    <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                        <li class="nav-item flex-fill" role="presentation">
                            <button class="nav-link w-100 active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home-justified" type="button" role="tab" aria-controls="home" aria-selected="true">Maintainance Report</button>
                        </li>
                        <!-- <li class="nav-item flex-fill" role="presentation">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" id="recipecount">
                                        ...
                                        <br>
                                        <div class="col-md-3" id="branddiv">
                                            <div class="form-floating mb-3">
                        ...
                        <table id="brandlist" class="table datatable display nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Cleaning count</th>
            ...
            $("#export").on('click', (function(e) {
               ...
               // $("#brandlist").load(location.href + " #brandlist");
                ...
                $.ajax({
                    ...
                    type: 'post',
                    url: 'reports/maintainance_report.php',
                    data: data,
                    success: function(responce) {
                        var obj = jQuery.parseJSON(responce);
                        var string1 = obj.error;
                        var msg =obj.error_msg;
                        var output = obj.ecc;
                        var brands = obj.brands;
                        //  console.log(output);
                        //  console.log(brands);
                        if (obj.error == 0 && brands != null) {
                            //swal(output);
                            ...
                            $.each(output, function(i, item) {
                                ...
                                if (item > 0) {
                                    k++;
                                    $('#brandlist').append('<tr><th scope="row">' + k + '</th><td>' + item + '</td><td>' + brands[i] + '</td></tr>');
                                }
                            ...
                            $(function() {
                                ...
                                $("#brandlist").table2excel({
                                    filename: "maintainance_report.xls"
                                });
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (obj.error == 0 && brands != null) {
                            ...
                            var options = {
                                series: [{
                                    name: 'End Of Day Cleaning Counter',
                                    data: output
                                }],
                                chart: {
