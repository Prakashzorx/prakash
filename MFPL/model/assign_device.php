...
if (!empty($_POST['machineid'])  && !empty($_POST['brand'])  && !empty($_POST['user']) && !empty($_POST['store']) && !empty($_POST['recipeversion'])) {

    // receiving the post params
    $machineid = $_POST['machineid'];
    $brand = $_POST['brand'];
    $recipeversion = $_POST['recipeversion'];
    ...
    foreach ($users as $user) {
        $x = assignDevice($machineid, $brand, $user, $store,$recipeversion);
        //echo($x);exit;
