            ...
            $('#machine').on('change', function() {
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $('#brand').html('<option value="' + obj.brand_id + '">' + obj.brand + '</option>');
                    }
                });

                $.ajax({
                    url: "model/getMachineWiseRctypes.php",
                    type: "POST",
                    data: {
                        id: id
                    },
                        ...
                        if (obj.error == 0 && rcptype != null) {
                            ...
                            $(function() {
                                ...
                                $("#brandlist").table2excel({
                                    filename: "most_selling_recipe.xls"
                                });
