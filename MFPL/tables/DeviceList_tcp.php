...
$columnName = '`tcp_assign_machine`.`id`'; //$_POST['columns'][$columnIndex]['data']; // Column name
...
$data = array();
$totalRecords = getDeviceDataTCPCount();
$totalRecordwithFilter = getDeviceDataSearchTCPCount($searchQuery, $query);
...
$i = 0;
$devices = [];
$devices = getDeviceRecordsTcp1Data($searchQuery, $columnName, $columnSortOrder, $row, $rowperpage, $query);
$i = $row;
