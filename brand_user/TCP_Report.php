                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" id="tcp_report">
                                        ...
                                        <input type="hidden" class="form-control" id="userid" name="userid" value="<?php echo $_SESSION['uid_user']; ?>">
                                        <div class="col-md-3">
            ...
            <div class="col-lg-12" id="tcp_table">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="brandlist" style="width:100%">
                            <thead>
                                <tr>
                                    <!-- <th scope="col">#</th> -->
            ...
            <div class="col-lg-12" id="tcp_table1" style="display:none">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Table with stripped rows -->
                        <table id="tcplist" style="width:100%">
                            <thead>
                                <tr>
                                    <th scope="col">#</th>
                    ...
                    success: function(responce) {
                       ...
                       // datet = [];
                        if (imei.length > 0) {
                            ...
                            //     text[index] = temp[item];
                            //     datet[index] = timestamp[item];
                            ...
                            var options = {
                                ...
                                colors: ['#0090FF', '#00E396', '#0090CC', '#00E312', '#009034', '#00E3F4', '#0090FF', '#00E396', '#0090FF', '#00E396'],
                                stroke: {
                                    curve: "smooth",
                                    width: 3
                                },
