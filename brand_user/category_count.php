                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating mb-3" id="userdiv">
                                                <select class="form-select" id="user" name="user" aria-label="">
                                                    ...
                                                    //     $i++;
                                                    ?>
                                                       <option value="<?php echo $_SESSION['uid_user']; ?>"><?php echo $_SESSION['uname']; ?></option>
                                                    <?php
                                                   // }
                                                    ?>
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-floating mb-3" id="storediv">
                                                <select class="form-select" id="store" name="store" aria-label="" onchange="storechange(this);">
                                                    <option value="">All</option>
                                                    <?php
                                                    $result =  getBrandAndUserStores($_SESSION['brand'],$_SESSION['uid_user']);
                                                    $i = 0;
                                                    //print_r($result);
                                                    foreach ($result as $row) {
                                                        $i++;
        ...
        fDate.addEventListener('change', function() {
         ...
         $(document).ready(function() {
            $('#ptype').on('change', function() {
                var id = this.value;
                var uid =$("#user").val();
                //console.log(uid);console.log(id);
                $.ajax({
                        ...
                        if (obj.error == 0 && dates[0] != '') {
                            ...
                            $.each(output, function(i, item) {
                               ...
                               // $.each(dates, function(i, field) {
                                    if (item != null) {
                                        k++;
                                        $('#brandlist').append('<tr><th scope="row">' + k + '</th><td>' + item + '</td><td>' + dates[i] + '</td></tr>');
                                    }
