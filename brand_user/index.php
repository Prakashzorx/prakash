...
$user1=$_SESSION['uid_user'];
$brand1=$_SESSION['brand'];

// if(isset($_POST['brand'])){

// }
$query1 = "AND `brand_tbl`.`id`='$brand1' AND `users`.`user_id`='$user1'";
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="card-body"> -->
                  ...
                  <?php
                  // $only_fryer = "SELECT * FROM `product_type`.`name` LIKE 'FRYER'";
...
$result=[];
		 ...
		 <div class="col-lg-12">
                ...
                //  print_r($result);
                  //exit;
                //  print_r($brand1);
               $brandtcpimei=getusertcpimei($user1);
               if($brandtcpimei>0)
               {
                  ...
                  //  print_r($brandimei . " wer");
                    $resultl = getnooftcpdatauser($brandimei);
